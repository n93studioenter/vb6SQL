...
Private Sub CboSohieu_Click()
    Dim rs As Object, i As Integer, tt As Double, dgia As Double, k As Integer
...
Private Sub InNVL()
    Dim SQL As String, rs As Object, i As Integer, sl As Double, mvt As Long, thangdm As String
